...
#define TIMER_SLOW_CLOCK_PER_SEC 2000
#define TIMER_FAST_CLOCK_PER_SEC 508000
...
#define TIMER4_VAL_LOW_OFFSET  0x00000000 // 32 bits, RO
#define TIMER4_VAL_HIGH_OFFSET 0x00000004 // 9 bits, RW
    #define TIMER4_VAL_MASK         0x000000FF
...
#define VIC_IRQ_STATUS_OFFSET       0x00000000
#define VIC_FIQ_STATUS_OFFSET       0x00000004
#define VIC_RAW_STATUS_OFFSET       0x00000008
#define VIC_INT_SELECT_OFFSET       0x0000000C
#define VIC_INT_EN_OFFSET           0x00000010
#define VIC_INT_EN_CLEAR_OFFSET     0x00000014
#define VIC_SWI_OFFSET              0x00000018
#define VIC_SWI_CLEAR_OFFSET        0x0000001C
#define VIC_VEC_ADDR_OFFSET         0x00000030
#define VIC_VEC_DEF_ADDR_OFFSET     0x00000034
#define VIC_VEC_ADDR_N_OFFSET(n)   (0x00000100 + (4 * (n)))
#define VIC_VEC_CTRL_N_OFFSET(n)   (0x00000200 + (4 * (n)))
    #define VIC_VEC_CTRL_EN_MASK        0x20

// Interrupts
#define VIC2_TIMER3_INT     19
#define VIC2_UART1_INT      20
#define VIC2_UART2_INT      22
